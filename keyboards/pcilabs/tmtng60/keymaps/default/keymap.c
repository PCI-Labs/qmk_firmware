...
void config_read_user(void) {
  ...
  memcpy(user_config.raw, raw, STRUCT_SIZE);
   ...
   rgblight_sethsv_noeeprom(user_config.rgb_color.h, user_config.rgb_color.s,
...
const int effects_array[] = {RGBLIGHT_MODE_STATIC_LIGHT, RGBLIGHT_MODE_BREATHING, RGBLIGHT_MODE_RAINBOW_MOOD, RGBLIGHT_MODE_RAINBOW_SWIRL + 2, RGBLIGHT_MODE_SNAKE, RGBLIGHT_MODE_KNIGHT, RGBLIGHT_MODE_CHRISTMAS, RGBLIGHT_MODE_STATIC_GRADIENT, RGBLIGHT_MODE_TWINKLE};
...
void raw_hid_receive(uint8_t *data, uint8_t length) {
  ...
  case 3:;
    ...
    user_config.key_chars[3] = data[4];
    user_config.key_chars[4] = data[5];
    user_config.key_chars[5] = data[6];
    user_config.key_chars[6] = data[7];
    user_config.key_chars[7] = data[8];
    user_config.key_chars[8] = data[9];
    user_config.key_chars[9] = data[10];
    user_config.key_chars[9] = data[11];
#endif
    config_update_user(user_config.raw);
    break;
